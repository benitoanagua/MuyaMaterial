...
export class ThemeBuilder {
  static buildTheme(scheme, terminalColors, name) {
    const theme = {
      ...
      tokenColors: [
        getCommentSettings(scheme, terminalColors),
        getConstantSettings(scheme, terminalColors),
        ...getEntitySettings(scheme, terminalColors),
        getKeywordSettings(scheme, terminalColors),
        ...getMarkupSettings(scheme, terminalColors),
        getMetaSettings(scheme, terminalColors),
        getStorageSettings(scheme, terminalColors),
        getOperatorSettings(scheme, terminalColors),
        getStringSettings(scheme, terminalColors),
        ...getSupportSettings(scheme, terminalColors),
        ...getVariableSettings(scheme, terminalColors),
        ...getVariousSettings(scheme, terminalColors),
      ],
    };
